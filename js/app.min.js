...
$(document).ready(function () {
  // Scale zoom in image //
  var imageContainers = document.querySelectorAll(".img-scale");
  imageContainers.forEach(function (imageContainer) {
    ...
    var removeZoomEffect = function removeZoomEffect() {
  ...
  handleChangeImage = function handleChangeImage(price, salePrice) {
    $(".color-tags").removeClass("item-border");
    $(".sale-price").text(salePrice);
    $(".original-price").text(price);
  };
