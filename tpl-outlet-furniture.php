...
<div class="custome-container">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu px-2 w-fit" aria-labelledby="dropdownMenuLink">
                    <div class="form-check">
                        ...
                        <label class="form-check-label text-20 gray-subtext" for="option1">
                            Price, low to high
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="option" id="option2">
                        <label class="form-check-label text-20 gray-subtext" for="option2">
                            Price, high to low
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="option" id="option3">
                        <label class="form-check-label text-20 gray-subtext" for="option3">
                            Product name A-Z
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="option" id="option4">
                        <label class="form-check-label text-20 gray-subtext" for="option4">
                            Product name Z-A
                        </label>
                    </div>
                </div>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center product-list custome-container-sm">
        <!-- product item -->
